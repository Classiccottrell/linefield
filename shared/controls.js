...
.lf-section-head { all: revert; appearance: none; background: none; border: none; padding: 0;
  ...
  color: #5fa07c; display: flex; align-items: center; justify-content: space-between; }
...
.lf-readout { font: 600 11px/1 ui-monospace,Menlo,monospace; color: #79af91; }
...
.lf-row input[type=range] { -webkit-appearance: none; appearance: none; width: 100%; height: 6px;
  ...
  background-image: linear-gradient(90deg,#2a4637,#437057 50%,#93bea6);
...
.lf-seg-btn.lf-seg-btn-active { color: #e8e8e8; border-color: #437057; }
.lf-seg-btn.lf-seg-btn-active::before { border-color: #437057; background: #437057; }
...
.lf-chip[aria-pressed="true"] { background: #437057; color: #e8e8e8; border-color: #437057; }
